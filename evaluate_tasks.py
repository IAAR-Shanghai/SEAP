...
def main(args):
    ...
    for prompt_type in prompt_types:
        ...
        # Join task names for batch eval
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prompt_types", nargs='+', required=True,
                        help="List of prompt types for calibration, e.g., cot knowledge")
    parser.add_argument("--task_types", nargs='+', required=True,
                        help="List of tasks to evaluate, e.g., gsm8k hellaswag")
    parser.add_argument("--calibration_task", type=str, required=True, help="Which task to use for pruning mask generation")
